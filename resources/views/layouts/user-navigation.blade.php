        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('user.logout') }}">
                    ...
                    <x-responsive-nav-link :href="route('user.items.index')" onclick="event.preventDefault(); this.closest('form').submit();">
                        {{ __('ホーム') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('user.cart.index')" onclick="event.preventDefault(); this.closest('form').submit();">
                        カートを表示
                    </x-responsive-nav-link>
                </form>
            </div>
