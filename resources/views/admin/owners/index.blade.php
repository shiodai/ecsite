                ...
                <div class="md:p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="container md:px-5 mx-auto">
                        ...
                        <div class="flex justify-end mt-8">
                            <button onclick="location.href='{{ route('admin.owners.create') }}'" class="text-white bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 rounded text-lg">新規追加</button>
                        </div>
                    </div>
                    </section>
